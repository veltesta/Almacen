...
public class ProductoPrecio extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ("INSERT INTO producto_precio(id_producto_precio,codigo_producto,precio,fecha_alta,fecha_baja) VALUES (?,?,?,?,?)");
        pst.setString(1, txtID.getText());
        pst.setString(2, txtCodigo.getText());
        pst.setString(3, txtPrecio.getText());
        pst.setString(4, txtFechaA.getText());
        pst.setString(5, txtFechaB.getText());
    ...
    JOptionPane.showMessageDialog(this, "Precio establecido correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
         this.dispose();
